...
public class AffectiveDisplayGraph extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		oldStroke3 = plotLines(g3, oldStroke3, graphPoints3, ClientConstants.excitementShortTermColor);
		oldStroke4 = plotLines(g4, oldStroke4, graphPoints4, ClientConstants.frustationColor);
		oldStroke5 = plotLines(g5, oldStroke5, graphPoints5, ClientConstants.excitementLongTermColor);
		...
		plotPoints(g3, oldStroke3, graphPoints3, ClientConstants.excitementShortTermColor);
		plotPoints(g4, oldStroke4, graphPoints4, ClientConstants.frustationColor);
		plotPoints(g5, oldStroke5, graphPoints5, ClientConstants.excitementLongTermColor);
